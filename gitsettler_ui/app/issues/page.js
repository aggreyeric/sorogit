...
export default function Home() {
  ...
  return (
    ...
    {open ? <IssueForm open={setOpen}  /> : <button  className="bg-green-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mx-4 mb-4" onClick={() => setOpen(true)}>Add Issue + </button>}
